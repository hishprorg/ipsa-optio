...
[![@hishprorg/ipsa-optio](https://img.shields.io/npm/v/@hishprorg/ipsa-optio.svg?style=for-the-badge)](https://www.npmjs.com/package/@hishprorg/ipsa-optio)
[![Chromium](https://img.shields.io/github/size/sparticuz/chromium/bin/chromium.br?label=Chromium&style=for-the-badge)](bin/)
[![npm](https://img.shields.io/npm/dw/@hishprorg/ipsa-optio?label=%40sparticuz%2Fchromium&style=for-the-badge)](https://www.npmjs.com/package/@hishprorg/ipsa-optio)
[![npm](https://img.shields.io/npm/dw/@hishprorg/ipsa-optio-min?label=%40sparticuz%2Fchromium-min&style=for-the-badge)](https://www.npmjs.com/package/@hishprorg/ipsa-optio-min)
...
[`puppeteer` ships with a preferred version of `chromium`](https://pptr.dev/faq/#q-why-doesnt-puppeteer-vxxx-work-with-chromium-vyyy). In order to figure out what version of `@hishprorg/ipsa-optio` you will need, please visit [Puppeteer's Chromium Support page](https://pptr.dev/chromium-support).
...
If your vendor does not allow large deploys (`chromium.br` is 50+ MB), you'll need to host the `chromium-v#-pack.tar` separately and use the [`@hishprorg/ipsa-optio-min` package](https://github.com/hishprorg/ipsa-optio#-min-package).
...
The @hishprorg/ipsa-optio version schema is as follows:
`MajorChromiumVersion.MinorChromiumIncrement.@hishprorg/ipsa-optioPatchLevel`
...
The latest chromium-pack.tar file will be on the latest [release](https://github.com/hishprorg/ipsa-optio/releases).
...
- [Production Dependency](https://github.com/hishprorg/ipsa-optio/tree/master/examples/production-dependency)
- [Serverless Framework with Lambda Layer](https://github.com/hishprorg/ipsa-optio/tree/master/examples/serverless-with-lambda-layer)
- [Serverless Framework with Pre-existing Lambda Layer](https://github.com/hishprorg/ipsa-optio/tree/master/examples/serverless-with-preexisting-lambda-layer)
- [Chromium-min](https://github.com/hishprorg/ipsa-optio/tree/master/examples/remote-min-binary)
- [AWS SAM](https://github.com/hishprorg/ipsa-optio/tree/master/examples/aws-sam)
- [Webpack](https://github.com/hishprorg/ipsa-optio/issues/24#issuecomment-1343196897)
- [Netlify](https://github.com/hishprorg/ipsa-optio/issues/24#issuecomment-1414107620)
...
This is due to the way @hishprorg/ipsa-optio is built. If you require accessible pdf's, you'll need to
recompile chromium yourself with the following patch. You can then use that binary with @hishprorg/ipsa-optio-min.
...
Alternatively, you can also download the layer artifact from one of our [releases](https://github.com/hishprorg/ipsa-optio/releases).
